...
server:~ > tar jxf wkssrc.tbz

# 設定 Gaussian 的根目錄
server:~ > export g16root=$HOME
# 進入原始碼目錄
server:~ > cd g16
# 載入 Gaussian 的環境設定檔
server:~/g16 > source bsd/g16.profile
```
...
server:~/g16 > sed -i s/p7-64/x86-64-v3/ bsd/set-mflags
# 將 bsd/setup-make 中的 p7-64 替換為 x86-64-v3
server:~/g16 > sed -i s/p7-64/x86-64-v3/ bsd/setup-make
```
